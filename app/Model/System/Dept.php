...
class Dept extends MineModel
{
    ...
    {
        return $this->belongsToMany(Role::class, 'system_role_dept', 'dept_id', 'role_id');
    }
    ...
    {
        return $this->belongsToMany(User::class, 'system_user_dept', 'dept_id', 'user_id');
    }
    ...
    {
        return $this->belongsToMany(User::class, 'system_dept_leader', 'dept_id', 'user_id');
    }
}
