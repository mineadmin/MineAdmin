 ...
 * @property Collection|User[] $receiveUser
 * @property User $sendUser
 */
class QueueMessage extends MineModel
{
    /**
     * 消息类型：通知.
     * @var string
    ...
    {
        return $this->belongsToMany(User::class, 'system_queue_message_receive', 'message_id', 'user_id')->as('receive_users')->withPivot(...['read_status']);
    }
}
