...
class User extends MineModel
{
    ...
    {
        return $this->belongsToMany(Role::class, 'system_user_role', 'user_id', 'role_id');
    }
    ...
    {
        return $this->belongsToMany(Post::class, 'system_user_post', 'user_id', 'post_id');
    }
    ...
    {
        return $this->belongsToMany(Dept::class, 'system_user_dept', 'user_id', 'dept_id');
    }
