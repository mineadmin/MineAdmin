...
use App\Repository\DataCenter\DictDataRepository;
...
{
    /**
     * @var DictDataRepository
     */
    public $repository;

    public function __construct(DictDataRepository $repository)
    {
    ...
    public function getList(?array $params = null, bool $isScope = false): array
    {
        ...
        return $this->repository->getList(array_merge($args, $params), $isScope);
    }
