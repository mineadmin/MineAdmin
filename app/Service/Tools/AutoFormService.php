...
use App\Repository\Tools\AutoFromRepository;
...
class AutoFormService
{
    ...
    public function __construct(AutoFromRepository $repository)
    {
    ...
    public function getList(?array $params = null, bool $isScope = true): array
    {
        ...
        return $this->repository->getList($params, $isScope);
    }
    ...
    public function getPageList(mixed $table_id, ?array $params = null, bool $isScope = true): array
    {
        ...
        return $this->repository->getPageList($table_id, $params, $isScope);
    }
    ...
    {
        return $this->repository->getSelectTree($table_id);
    }
    ...
    public function getTreeList(mixed $table_id, ?array $params = null, bool $isScope = true): array
    {
        ...
        $params['recycle'] = false;
        return $this->repository->getTreeList($table_id, $params, $isScope);
    }
    ...
    {
        return $this->repository->save($table_id, $data);
    }
    ...
    public function batchSave(mixed $table_id, array $collects): bool
    {
        return Db::transaction(function () use ($collects, $table_id) {
            foreach ($collects as $collect) {
                $this->repository->save($table_id, $collect);
            }
            return true;
        });
    }
    ...
    {
        return $this->repository->read($table_id, $id, $column);
    }
    ...
    {
        return $this->repository->value($table_id, $condition, $columns);
    }
    ...
    {
        return $this->repository->pluck($table_id, $condition, $columns);
    }
    ...
    {
        return $this->repository->readByRecycle($table_id, $id);
    }
    ...
    {
        return ! empty($ids) && $this->repository->delete($table_id, $ids);
    }
    ...
    {
        return $this->repository->update($table_id, $id, $data);
    }
    ...
    {
        return $this->repository->updateByCondition($table_id, $condition, $data);
    }
    ...
    {
        return ! empty($ids) && $this->repository->realDelete($table_id, $ids);
    }
    ...
    {
        return ! empty($ids) && $this->repository->recovery($table_id, $ids);
    }
    ...
    {
        return ! empty($ids) && $this->repository->disable($table_id, $ids, $field);
    }
    ...
    {
        return ! empty($ids) && $this->repository->enable($table_id, $ids, $field);
    }
    ...
    {
        return $value == 1 ? $this->repository->enable($table_id, [$id], $filed) : $this->repository->disable($table_id, [$id], $filed);
    }
    ...
    {
        return $this->repository->numberOperation($table_id, $id, $field, $value);
    }
    ...
    public function export(array $params, ?string $dto, ?string $filename = null, ?\Closure $callbackData = null): ResponseInterface
    {
        ...
        if (empty($filename)) {
            $filename = $this->repository->getModel()->getTable();
        }

        return (new MineCollection())->export($dto, $filename, $this->repository->getList($params), $callbackData);
    }
    ...
    public function import(string $dto, ?\Closure $closure = null): bool
    {
        return Db::transaction(function () use ($dto, $closure) {
            return $this->repository->import($dto, $closure);
        });
    }
    ...
    public function getRemoteList(array $params = []): array
    {
        ...
        return $this->repository->getRemoteList(array_merge($params, $remoteOption));
    }
