 ...
 * @property string $log_content 队列内容
 ...
 */
class SystemQueue extends MineModel
{
    /**
     * @Message("未生产")
     */
     ...
     * @var array
     */
    protected $fillable = ['id', 'uuid', 'exchange_name', 'routing_key_name', 'queue_name', 'queue_content', 'log_content', 'produce_status', 'consume_status', 'delay_time', 'created_by', 'updated_by', 'created_at', 'updated_at', 'deleted_at', 'remark'];
    /**
