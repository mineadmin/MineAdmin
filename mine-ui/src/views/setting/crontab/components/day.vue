  ...
  <el-form size="small">
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="3">
        周期从
        <el-input-number v-model="cycle01" :min="0" :max="31" controls-position="right" /> -
        <el-input-number v-model="cycle02" :min="0" :max="31" controls-position="right" /> 日
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="4">
        从
        <el-input-number v-model="average01" :min="0" :max="31" controls-position="right" /> 号开始，每
        <el-input-number v-model="average02" :min="0" :max="31" controls-position="right" /> 日执行一次
      </el-radio>
    </el-form-item>
<!-- 
    <el-form-item>
