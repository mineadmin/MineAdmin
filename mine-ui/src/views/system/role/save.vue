  ...
  <el-dialog :title="titleMap[mode]" v-model="visible" :width="500" destroy-on-close @closed="$emit('closed')">
    <el-form :model="form" :rules="rules" :disabled="mode=='show'" ref="dialogForm" label-width="80px">
      ...
      <el-form-item label="角色名称" prop="name">
        <el-input v-model="form.name" size="small" clearable placeholder="请输入角色名称"></el-input>
      </el-form-item>

      <el-form-item label="代码" prop="code">
        <el-input v-model="form.code" size="small" clearable placeholder="请输入角色代码"></el-input>
      </el-form-item>
